...
static const char *upvol[] = {"/usr/bin/pactl", "set-sink-volume", "1", "+5%",
                              NULL};
static const char *downvol[] = {"/usr/bin/pactl", "set-sink-volume", "1", "-5%",
                                NULL};
static const char *mutevol[] = {"/usr/bin/pactl", "set-sink-mute", "1",
                                "toggle", NULL};
...
const char *spcmd3[] = {"st", NULL};
// const char *spcmd4[] = {"st", "-n", "calendar", "-g", "144x60", "calendar",
// NULL }; const char *spcmd4[] = {"chromium", NULL };
...
static const Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_e, spawn, SHCMD("st lf")},
